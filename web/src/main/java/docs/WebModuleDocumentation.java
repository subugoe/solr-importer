...
class WebModuleDocumentation {
	...
	void webEntryPoint() throws Exception {
		 ...
		 */ objectOf(MainController.class).deleteLockFile(arg(Model.class), arg(UriComponentsBuilder.class)); /*
		 ...
		 */ objectOf(MainController.class).swapCores(arg(Model.class), arg(UriComponentsBuilder.class)); /*
